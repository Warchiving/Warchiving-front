...
const styles = StyleSheet.create({
  ...
  detailsContainer: { paddingTop: 2, paddingHorizontal: 20, paddingBottom: 20 },
  ...
  bookButton: { backgroundColor: colors.Black, padding: 15, alignItems: 'center', marginTop: 20, borderRadius: 10 },
